...
RSpec.describe "books", type: :system do
  ...
  it "教科書一覧画面にbooksデータが表示されること" do
    visit books_path
  ...
  it "教科書一覧画面に新しく登録するリンクが表示されること" do
    visit books_path
    expect(page).to have_link("教科書を新しく登録する")
  end

  it "教科書登録画面に教科書を登録するボタンが表示されること" do
    visit new_book_path
    expect(page).to have_button("教科書を登録する")
  end

  it "教科書登録画面に入力欄が表示されること" do
    visit new_book_path
  ...
  it "教科書登録画面で教科書一覧に戻るをクリックすると一覧画面へ遷移すること" do
    visit new_book_path
    click_link "教科書一覧に戻る"
  ...
  it "教科書の情報画面に教科書一覧リンクが表示されること" do
    visit book_path(book)
    expect(page).to have_link("教科書一覧")
  end

  it "教科書の編集画面で教科書の編集を完了するボタンが表示されること" do
    visit edit_book_path(book)
    expect(page).to have_button("教科書の編集を完了する")
  end

  it "教科書の編集画面でタイトル入力欄が表示されること" do
    visit edit_book_path(book)
    expect(page).to have_field("タイトル")
    expect(page).to have_field("棚の番号")
    expect(page).to have_field("ISBN")
  ...
  it "教科書の読み取り画面でISBN読み取りが表示されること" do
    visit books_scanner_path
    expect(page).to have_content("ISBN読み取り画面")
  end

  it "教科書の読み取り画面でISBN読み取り部分のCSSが表示されること" do
    visit books_scanner_path
